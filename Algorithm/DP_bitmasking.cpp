...
long long int countWaysUtil(int mask,int i)
{
    ...
    //size is total number of persons having cap with id i.
    ...
    for(int j=0;j<size;j++)
    {
        ...
        //Else assign him this cap and recur for remaining caps with new
        //updated mask vector
        else
...
//Read n lines from standard input for current test case
void countWays(int n)
{
    ...
    //Initialzie all entries in dp as -1
